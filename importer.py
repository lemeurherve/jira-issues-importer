...
class Importer:
    ...
    def __init__(self, project):
        ...
        self.jira_to_github_txt_mapping = f'jira-keys-to-github-id-for-post-process_{self.project.current_datedime}.txt'
        self.jira_to_complete_github_txt_mapping = f'jira-keys-to-github-id_{self.project.current_datedime}.txt'
